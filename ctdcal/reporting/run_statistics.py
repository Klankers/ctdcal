...
#   Can use log_cli to write the log file out
...
def run_log_end():
    """
    Toc, # of stations run as per the designated list, # of failures/files unaccounted for, etc.
    """
    pass
...
def run_fit_params():
    ...
    col4 : Dict of fit coefficients (A: -1.5566e-10, B: 3.40556e2, gain: 1.0031e0, etc.)
